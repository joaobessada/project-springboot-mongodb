package com.bessada.workshopmongo.config;
...
import com.bessada.workshopmongo.dto.AuthorDTO;
import com.bessada.workshopmongo.dto.CommentDTO;
import com.bessada.workshopmongo.repository.PostRepository;
import com.bessada.workshopmongo.repository.UserRepository;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... arg0) throws Exception {
		...
		CommentDTO c3 = new CommentDTO("Have a nice day!", sdf.parse("23/09/2018"), new AuthorDTO(alex));
